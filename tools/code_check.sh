...
SUPPRESS=/tmp/ignition_launch_check.suppress
touch $SUPPRESS
...
CPPCHECK_BASE="cppcheck -j$MAKE_JOBS --inline-suppr -DIGNITION_VISIBLE=1 -q --suppressions-list=$SUPPRESS"
...
CPPCHECK_RULES="--rule-file=./tools/cppcheck_rules/isinf_namespace.rule"
